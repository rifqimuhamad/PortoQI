                    ...
                    <table class="min-w-full divide-y divide-gray-800">
                      ...
                      <tbody class="bg-gray-900 divide-y divide-gray-800">
                        ...
                        <tr>
                          <td class="px-6 py-4 whitespace-nowrap text-gray-50">
                            <div class="flex items-center">
                              <div class="flex-shrink-0 h-10 w-10">
                                <img class="h-10 w-10 rounded-full" src="{{ asset('img/clients/' . $clients->image) }}" alt="{{ $clients->judul }}">
                              </div>
                            </div>
                          </td>
                          <td class="px-6 py-4 whitespace-nowrap text-gray-50">
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-gray-50">
                            <a href="{{ route('clients.edit', $clients->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            <form onsubmit="return confirm('Are you sure you want to delete?')"
                                action="{{ route('clients.destroy', $clients->id) }}" class="d-inline" method="POST">
                                @csrf
                                @method('DELETE')
